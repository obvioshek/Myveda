...
export type StorageHash =
  StorageHashBase<'06c3ae25958e370a3f11c04274d6be5c87bb8ef16703309fd6f3e0bac9f4be1e'>;
export type ExecutionHash =
  ExecutionHashBase<'f56cdd8db84e6b05ec3d1ae0ace623aabb979cf4a11d030a6acc4344adcf733d'>;
...
export namespace Models {
  export type public_User = {
    ...
    readonly [RelationKeys]?:
      'feedSessions' | 'posts' | 'reactions' | 'saves' | 'seenPosts' | 'topicFollows';
  };
  ...
  export type public_Post = {
    ...
    readonly [RelationKeys]?:
      'feedItems' | 'org' | 'pollOptions' | 'reactions' | 'saves' | 'seenBy' | 'topic' | 'user';
  };
